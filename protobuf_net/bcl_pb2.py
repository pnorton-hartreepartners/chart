...
_DATETIME_DATETIMEKIND = _descriptor.EnumDescriptor(
  name='DateTimeKind',
...
_sym_db.RegisterEnumDescriptor(_DATETIME_DATETIMEKIND)
...
_DATETIME = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='kind', full_name='bcl.DateTime.kind', index=2,
...
_DATETIME.fields_by_name['kind'].enum_type = _DATETIME_DATETIMEKIND
_DATETIME_TIMESPANSCALE.containing_type = _DATETIME
_DATETIME_DATETIMEKIND.containing_type = _DATETIME
